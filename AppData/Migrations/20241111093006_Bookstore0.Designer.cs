...
namespace AppData.Migrations
{
    ...
    [Migration("20241111093006_Bookstore0")]
    partial class Bookstore0
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppData.NhanVien", b =>
                {
                    ...
                    b.Property<Guid?>("IdVaiTroNavigationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IdVaiTroNavigationId");
            ...
            modelBuilder.Entity("AppData.HoaDon", b =>
                {
                    ...
                    b.HasOne("AppData.KhachHang", null)
                        .WithMany("HoaDons")
                        .HasForeignKey("KhachHangId");

                    b.HasOne("AppData.NhanVien", null)
                        .WithMany("HoaDons")
                        .HasForeignKey("NhanVienId");
            ...
            modelBuilder.Entity("AppData.NhanVien", b =>
                {
                    ...
                    b.HasOne("AppData.VaiTro", "IdVaiTroNavigation")
                        .WithMany()
                        .HasForeignKey("IdVaiTroNavigationId");
